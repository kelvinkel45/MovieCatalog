...
public class FakeCatalogRepository implements CatalogDataSource {
    ...
    private volatile static FakeCatalogRepository INSTANCE = null;

    FakeCatalogRepository(LocalRepository localRepository, RemoteRepository remoteRepository, AppExecutors appExecutors) {
        this.localRepository = localRepository;
        this.remoteRepository = remoteRepository;
        this.appExecutors = appExecutors;
    }

    public static FakeCatalogRepository getInstance(LocalRepository localRepository, RemoteRepository remoteRepository, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (FakeCatalogRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeCatalogRepository(localRepository, remoteRepository, appExecutors);
                }
            }
        }
        return INSTANCE;
